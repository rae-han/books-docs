...
| Ch | 제목 | 핵심 단어 | 한 줄 요약 |
|----|------|-----------|-----------|
| 1 | [이 책의 활용법](notes/ch01-how-to-use-this-book.md) | 책 사용법 | 처음부터 다 읽지 않아도 된다 - 지금 필요한 부(部)부터 |
...
| 8 | [코딩 부트캠프](notes/ch08-coding-bootcamps.md) | 부트캠프 | 압축 성장의 장단점과 고르는 기준 |
| 9 | [독학](notes/ch09-self-study.md) | 독학 전략 | 자기 주도 학습의 설계 - 커리큘럼을 스스로 만든다 |
...
| 18 | [타 기술직에서 개발직으로 옮겨오기](notes/ch18-moving-from-another-tech-field.md) | 직군 이동 | QA·운영 등 인접 직군에서 개발로 옮기는 경로 |
| 19 | [계약직 vs. 정규직](notes/ch19-contractor-vs-employee.md) | 고용 형태 | 계약직과 정규직의 손익 계산 |
| 20 | [헤드헌팅 업계의 작동 방식](notes/ch20-how-recruiting-works.md) | 리크루터 인센티브 | 헤드헌터가 움직이는 원리를 알면 협상이 보인다 |
...
> 하늘 아래 논쟁에서 이길 유일한 방법은 논쟁을 피하는 것이다. 방울뱀이나 지진을 피하듯이 논쟁을 피하라.<br>- 데일 카네기(Dale Carnegie) (위치: Ch36)

> 당신은 당신이 자주 만나는 5명의 평균이다.<br>- 짐 론(Jim Rohn) (위치: Ch39)

> 폭군의 한계는 억압당하는 자들이 어디까지 참느냐에 따라 정해진다.<br>- 프레더릭 더글러스(Frederick Douglass) (위치: Ch44)

> 재능 낭비군. 권력을 두고 돈을 선택하다니. 돈은 10년 후면 허물어버릴 싸구려 저택 같은 것이고, 권력이란 수 세기가 지나도 굳건히 버티는 석조 건물이건만.<br>- 프랭크 언더우드, 〈하우스 오브 카드〉 (위치: Ch46)

> 다른 사람들이 원하는 걸 얻도록 도와준다면 당신도 자신이 원하는 모든 것을 얻을 수 있을 것이다.<br>- 지그 지글러(Zig Ziglar), "클로징" (위치: Ch48)

> 개인의 삶의 질은 그가 받아들일 수 있는 불확실성의 양과 정비례한다.<br>- 토니 로빈스(Tony Robbins) (위치: Ch56)
