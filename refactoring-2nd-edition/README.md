...
| 3 | **Bad Smells in Code (코드에서 나는 악취)** | ch03-bad-smells-in-code.md | ⬜ |
| 4 | **Building Tests (테스트 구축하기)** | ch04-building-tests.md | ⬜ |
| 5 | **Introducing the Catalog (리팩터링 카탈로그 보는 법)** | ch05-introducing-the-catalog.md | ⬜ |

### 카탈로그편 (Ch6~12) — 기법 카탈로그

| Ch | 제목 | 파일 | 상태 |
|---|---|---|---|
| 6 | **A First Set of Refactorings (기본적인 리팩터링)** | [ch06-a-first-set-of-refactorings.md](ch06-a-first-set-of-refactorings.md) | ✅ |
| 7 | **Encapsulation (캡슐화)** | ch07-encapsulation.md | ⬜ |
| 8 | **Moving Features (기능 이동)** | ch08-moving-features.md | ⬜ |
| 9 | **Organizing Data (데이터 조직화)** | ch09-organizing-data.md | ⬜ |
| 10 | **Simplifying Conditional Logic (조건부 로직 간소화)** | ch10-simplifying-conditional-logic.md | ⬜ |
| 11 | **Refactoring APIs (API 리팩터링)** | ch11-refactoring-apis.md | ⬜ |
| 12 | **Dealing with Inheritance (상속 다루기)** | ch12-dealing-with-inheritance.md | ⬜ |

### 부록

| 부록 | 제목 | 파일 | 상태 |
|---|---|---|---|
| A | **리팩터링 목록** | appendix-a-list-of-refactorings.md | ⬜ |
| B | **악취 제거 기법** | appendix-b-smells-to-refactorings.md | ⬜ |

> 진행 중인 프로젝트입니다. ✅ = 작성 완료, ⬜ = 예정.
