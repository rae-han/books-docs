...
| Ch | 제목 | 핵심 단어 | 한 줄 요약 |
|----|------|-----------|-----------|
| 1 | [Introduction](notes/ch01-introduction.md) | 아키텍처 4요소, 아키텍트 기대치, 아키텍처 법칙 | 아키텍처 = 구조+특성+결정+원칙, 아키텍트의 8가지 기대치와 세 가지 법칙 |
...
| 부록 | 제목 | 핵심 단어 | 한 줄 요약 |
|----|------|-----------|-----------|
| A | [토론용 질문 모음](notes/appendix-a-discussion-questions.md) | 자율평가 | 27개 장별 토론·복습용 질문 |
