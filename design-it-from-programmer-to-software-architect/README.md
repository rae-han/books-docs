...
> 다수의 인스턴스에서 새 버전을 배포할 때 가장 간과하기 쉬운 것 중 하나가 배포다. … 다수 인스턴스를 운용하면 언제든 불일치가 일어날 수 있다고 가정해야 한다.<br>— 렌 배스(Len Bass), 『소프트웨어 아키텍처 이론과 실제』 공저자 (위치: Ch6)

> 단순하고 완결성 있게 하세요.<br>— 사이먼 브라운(Simon Brown), 『Software Architecture for Developers』 저자 (위치: Ch10)
