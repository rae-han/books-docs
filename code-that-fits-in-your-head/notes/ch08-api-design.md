...
> 행동 유도성(어포던스, affordance)은 물체나 사람(또는 동물·인간·기계·로봇 등 상호관계하는 모든 중개자) 사이의 관계를 설명하는 것이다. 객체의 속성과 그 객체의 사용 가능성을 결정하는 중개자 관계라고도 이야기할 수 있다. 예컨대 의자는 받침을 제공하기 때문에 앉을 수 있으며, 대부분 한 사람이 옮길 수 있지만, 어떤 의자는 힘이 센 사람이 필요하거나 여러 명이 힘을 합쳐야 들어올릴 수 있는 것도 있다.<br>- 도널드 노먼
...
> 추상화는 무관한 것을 제거하고, 본질적인 것을 강조하는 것이다.<br>- 로버트 C. 마틴(Robert C. Martin)
